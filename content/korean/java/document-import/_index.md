---
date: 2026-02-16
description: GroupDocs.Merger를 사용하여 Java로 PDF를 PPTX로 변환하는 방법을 배우고, PDF를 PowerPoint에
  병합하고, Java로 문서를 변환하며, 스프레드시트를 Java로 효율적으로 병합하는 방법도 알아보세요.
title: Java를 사용하여 PDF를 PPTX로 변환 – GroupDocs.Merger
type: docs
